...
import { level3Rubbishes } from "../../../../../utils/genericData";
...
export default function Level2({ setActiveGameLevel, activeGameLevel }) {
  ...
  const handleOnRubbishDrop = (dustbin, e) => {
    ...
    if (level3Rubbishes[counter].type !== dustbin.type) {
      return;
    }
    ...
    if (counter >= level3Rubbishes.length - 1) {
  ...
  return (
    <div>
      ...
      >
        ...
        >
          {level3Rubbishes.map((rubbish, indx) => {
            return (
              <div
      ...
      <div id="games_wrapper_main" className="pt-4">
        <div>
          ...
          <div ref={beingDragRef} id="rubbish" className="rounded mt-5   ">
            <div
              onDrag={(e) => {
                handleOnDrag(level3Rubbishes[counter]);
              }}
            >
              <img
                draggable={true}
                // draggable={true}
                src={level3Rubbishes[counter]?.image}
                style={{
